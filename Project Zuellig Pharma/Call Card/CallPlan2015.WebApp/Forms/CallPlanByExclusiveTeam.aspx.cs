...
{
    public partial class CallPlanByExclusiveTeam : BasePage
    {
...
//                                            AND A.CMGRP2 in ('TD1','PH1') 	
//										", Session[Constants.SESSION_EXCLUSIVE_DATE].ToString(), scCode);
