...
{
    public partial class GLPharmaDateChoose : System.Web.UI.Page
    {
        ...
        protected void btnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Session[Constants.SESSION_GL_Pharmacy_DATE_SHOW] = dt.ToString("dd/MM/yyyy");
                Session[Constants.SESSION_GL_Pharmacy_DATE] = dt.ToString("yyyyMMdd");
                lblDate.Text = dt.ToString("yyyyMMdd");
                Response.Redirect("~/Forms/CallPlanByGLPharmacy.aspx");
            }
            catch (Exception)
            {
