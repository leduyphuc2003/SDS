...
{
    public partial class GovHosDateChoose : System.Web.UI.Page
    {
        ...
        protected void btnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Session[Constants.SESSION_GOV_HOS_DATE_SHOW] = dt.ToString("dd/MM/yyyy");
                Session[Constants.SESSION_GOV_HOS_DATE] = dt.ToString("yyyyMMdd");
                lblDate.Text = dt.ToString("yyyyMMdd");
                Response.Redirect("~/Forms/CallPlanByGovHospital.aspx");
            }
            catch (Exception)
            {
