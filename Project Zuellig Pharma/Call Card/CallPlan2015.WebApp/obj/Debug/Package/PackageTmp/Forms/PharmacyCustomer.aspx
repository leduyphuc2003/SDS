...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">PHARMACY CALL CARD<span style="color: green"></span></h2>
	<div class="row">
   ...
   <div class="form-group">
						...
						<tr <%# ((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Others")
							...
							<td align="right">
							    <%# ((((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Others") == false)
                                 ...
                                 ? ((PharmacyCustomerData)Container.DataItem).Ave6LastMonthQuantity.ToString() : string.Empty %>
							</td>
							<td align="right">
							    <%# ((((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Others") == false)
                                 && (((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Sum") == false))
                                 ? ((PharmacyCustomerData)Container.DataItem).MtdAllSourcesQuantity.ToString(): string.Empty %>
							</td>
                            <td align="right">
							    <%# ((((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Others") == false)
                                 && (((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Sum") == false))
                                 ?((PharmacyCustomerData)Container.DataItem).MtdScSourcesQuantity.ToString() : string.Empty %>
							</td>
							<td align="right">
    ...
    <script type="text/javascript">
        function ShowPharmacyDetail(customerCode) {
            ...
            else if (customerCode.indexOf('Sum') >= 0) {
