<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallCardByGovHospital.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallCardByGovHospital" %>
<%@ Import Namespace="CallPlan2015.Common" %>
<%@ Import Namespace="CallPlan2015.DataModel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">GL GOVERMENT HOSPITAL CALL CARD<span style="color: green"></span></h2>
	<div class="row">
		...
		<div class="col-md-12">
			<table class="list-table">
			    <tr class="list-title-bg">
					...
					<td align="center" rowspan="2" style="width: 150px">PRO CODE</td>
					<td align="center" rowspan="2">DESCRIPTION</td>
					<td colspan="3" style="font-weight: bold">Data by Unit ( for tender SKUs)</td>
					<!-- <td style="font-weight: bold">Data by quantity</td> -->
				</tr>
				<tr class="list-title-bg">
				...
				<asp:Repeater runat="server" ID="rPharmacyCustomer">
					<ItemTemplate>
						<tr <%# ((PharmacyCustomerData)Container.DataItem).PrnCode.Contains("Others")
						    ...
						    <td align="left"><asp:Label runat="server" ID="lblProCode" Text="<%#((PharmacyCustomerData)Container.DataItem).ProCode%>"/></td>
    ...
    <script type="text/javascript">
        function ShowPharmacyDetail(customerCode) {
            if (customerCode.indexOf('Others') >= 0) {
                var newwindow = window.open("CallCardByGovHospital.aspx" + "?detail=" + customerCode.replace('Others ', ''), 'Pharmacy by customer', 'height=600,width=800');
                if (window.focus) {
                    newwindow.focus();
                }
            }
