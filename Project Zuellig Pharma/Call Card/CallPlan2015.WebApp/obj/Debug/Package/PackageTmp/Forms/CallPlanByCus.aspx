<%@ Page Title="ZPV Call Card System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallPlanByCus.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallPlanByCus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">DAILY PHARMACY CALL PLAN</h2>
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <label><%= Session[Constants.SESSION_PHARMACY_DATE_SHOW] %></label>
                </div>
                <%--<div class="form-group">
					<label>Year: </label>
