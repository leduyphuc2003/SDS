<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallPlanByGLPharmacy.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallPlanByGLPharmacy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">DAILY GL PHARMACY CALL PLAN</h2>
    <div class="row">
    ...
    <script type="text/javascript">
        function LinkToPharmacyCustomer(customerCode) {
            ...
            window.location = "CallCardByGLPharmacy.aspx" + "?cc=" + customerCode;
        }
    </script>
</asp:Content>