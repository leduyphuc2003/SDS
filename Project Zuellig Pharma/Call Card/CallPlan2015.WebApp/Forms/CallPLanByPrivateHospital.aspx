<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallPLanByPrivateHospital.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallPLanByPrivateHospital" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">DAILY PRIVATE HOSPITAL CALL PLAN</h2>
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="form-inline">
                <div class="form-group">
                    ...
                    <label><%= Session[Constants.SESSION_PRI_HOS_DATE_SHOW] %></label>
                </div>
                <%--<div class="form-group">
					<label>Year: </label>
    ...
    <script type="text/javascript">
        function LinkToPharmacyCustomer(customerCode) {
            ...
            window.location = "CallCardByPrivateHospital.aspx" + "?cc=" + customerCode;
        }
    </script>
</asp:Content>