<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallPlanByExclusiveTeam.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallPlanByExclusiveTeam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">Exclusive CALL PLAN</h2>
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <label><%= Session[Constants.SESSION_EXCLUSIVE_DATE_SHOW] %></label>
                </div>
                <%--<div class="form-group">
					<label>Year: </label>
                ...
                <asp:Repeater runat="server" ID="rCustomer">
                    <ItemTemplate>
                        ...
                        <tr class="<%# GenerateClass(((CallPlanData)Container.DataItem), Container.ItemIndex % 2 + 1) %>"
                            ...
                            <%--icon checked--%>
                            <td align="center" style="<%# ChangeIcon( ((CallPlanData)Container.DataItem)) %>">
    ...
    <script type="text/javascript">
        function LinkToPharmacyCustomer(customerCode) {
            //var newwindow = window.open("http://localhost/CallPlan2015/CallPlan2015.WebApp/Forms/CallCardByExclusiveTeam.aspx", 'Pharmacy by customer', 'height=600,width=800');
            //if (window.focus) {
            //    newwindow.focus();
            //}

            //return false;
            //khi click vao cust se open ra link dan den trang callcard PhaymacyCustomer va truyen qua tham so cc
            window.location = "CallCardByExclusiveTeam.aspx" + "?cc=" + customerCode;
        }
    </script>
</asp:Content>