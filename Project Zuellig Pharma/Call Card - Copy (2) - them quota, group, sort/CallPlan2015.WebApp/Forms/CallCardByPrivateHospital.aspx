<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallCardByPrivateHospital.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallCardByPrivateHospital" %>
<%@ Import Namespace="CallPlan2015.Common" %>
<%@ Import Namespace="CallPlan2015.DataModel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">PRIVATE HOSPITAL CALL CARD<span style="color: green"></span></h2>
	<div class="row">
		...
		<div class="col-md-5 col-md-offset-1">
			<div class="form-inline">
				<div class="form-group">
					...
					<label runat="server" ID="lblContacPerson"></label>
				</div>
			</div>
		</div>
        <div class="col-md-5">
    ...
    <script type="text/javascript">
        function ShowPharmacyDetail(customerCode) {
            if (customerCode.indexOf('Others') >= 0) {
                var newwindow = window.open("CallCardByPrivateHospital.aspx" + "?detail=" + customerCode.replace('Others ', ''), 'Pharmacy by customer', 'height=600,width=800');
                if (window.focus) {
                    newwindow.focus();
                }
            }
