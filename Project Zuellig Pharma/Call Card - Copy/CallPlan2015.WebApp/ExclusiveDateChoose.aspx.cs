...
{
    public partial class ExclusiveDateChoose : System.Web.UI.Page
    {
        ...
        protected void btnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Session[Constants.SESSION_EXCLUSIVE_DATE_SHOW] = dt.ToString("dd/MM/yyyy");
                Session[Constants.SESSION_EXCLUSIVE_DATE] = dt.ToString("yyyyMMdd");
                lblDate.Text = dt.ToString("yyyyMMdd");
                Response.Redirect("~/Forms/CallPlanByExclusiveTeam.aspx");
            }
            catch (Exception)
            {
