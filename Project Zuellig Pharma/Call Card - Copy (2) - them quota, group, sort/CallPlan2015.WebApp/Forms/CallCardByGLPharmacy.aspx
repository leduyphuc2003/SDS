<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallCardByGLPharmacy.aspx.cs" Inherits="CallPlan2015.WebApp.Forms.CallCardByGLPharmacy" %>
<%@ Import Namespace="CallPlan2015.Common" %>
<%@ Import Namespace="CallPlan2015.DataModel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 align="center" style="color: #008B8B">GL PHARMACY CALL CARD<span style="color: green"></span></h2>
	<div class="row">
    ...
    <script type="text/javascript">
        function ShowPharmacyDetail(customerCode) {
            if (customerCode.indexOf('Others') >= 0) {
                var newwindow = window.open("CallCardByGLPharmacy.aspx" + "?detail=" + customerCode.replace('Others ', ''), 'Pharmacy by customer', 'height=600,width=800');
                if (window.focus) {
                    newwindow.focus();
                }
            }
